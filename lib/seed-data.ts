...
export const seedReviews: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Increíble comida caribeña. El mofongo es auténtico y delicioso. ¡Me sentí como en casa!",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Los tacos más auténticos fuera de México. Las tortillas son hechas a mano. Imperdible.",
  ...
  },
  {
    ...
    rating: 5,
    comment:
      "Best salsa classes in Zurich! The instructors are passionate and professional.",
...
export const seedPosts: Post[] = [
  ...
  },
  {
    ...
    businessId: "la-taqueria",
    content:
      "Taco Tuesday special: 3 tacos + margarita for CHF 25. Don't miss it! 🌮",
